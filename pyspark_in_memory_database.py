...
in_memory_products_dataframe.write.format("parquet").saveAsTable("on_disk_table_products")

in_memory_customers_dataframe.write.format("parquet").saveAsTable("on_disk_table_customers")
# --------------------------------------------
...
df_invoices_final.write.format("parquet").saveAsTable(permanent_table_name)
# ------------------------------------------------------------------
